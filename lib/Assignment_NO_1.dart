...
void main() {
  runApp(AssignmentNo1());
}

class AssignmentNo1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Assignment_NO 1 Calculators',
...
class _UtilityHomePageState extends State<UtilityHomePage> {
  BoxDecoration boxDecoration=BoxDecoration(
    gradient: LinearGradient(colors: [Color(0xfffff1eb),Color(0xfface0f9)])
  );
  int _index = 0; // 0: BMI, 1: Tip, 2: Age, 3: Currency, 4: To-Do, 5: Quadratic, 6: Temperature, 7: SDT, 8: Discount, 9: Fuel
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Assignment NO 1 Calculators'),
